...
def get_args():
    ...
    parser.add_argument('-curve',
                        choices=['OFDM_LS', 'OFDM_MMSE', 'TFECCNet_MAAttn', 'TFECCNet_SEAttn', 'TFECCNet_ResAttn',
                                 'TFECCNet_BiAttn', 'TFECCNet_NoAttn', 'TFECCNet_general', 'ECCNet_MAAttn',
                                 'ECCNet_SEAttn', 'ECCNet_ResAttn', 'ECCNet_BiAttn', 'ECCNet_NoAttn', 'ECCNet_general'],
                        default='OFDM_LS', help='for main')
